...
class ManualAddPage(BasePage):
    _member_name_ele = (MobileBy.ID, 'azh')
    _member_gender_ele = (MobileBy.XPATH, "//*[@text='男']")
    _member_male_ele = (MobileBy.XPATH, "//*[@resource-id='com.tencent.wework:id/bf_']/android.widget.RelativeLayout[1]")
    _member_female_ele = (MobileBy.XPATH, "//*[@resource-id='com.tencent.wework:id/bf_']/android.widget.RelativeLayout[2]")
